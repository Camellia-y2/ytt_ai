    ...
    <div className={`${styles.container} font-f`}>
      ...
      <header className={styles.header}>
        <div className={styles.headerContent}>
          ...
          <h1 className={styles.headerTitle}>{userInfo.nickname}</h1>
          <p className={styles.headerSubtitle}>{userInfo.slogan}</p>
          <p className={styles.headerLevel}>铲屎官{userInfo.level}</p>
        </div>
      </header>
